...
/// @param filename
/// @return
auto Sorcery::AudioPlayer::_load(const std::filesystem::path &filename) -> void {
	...
	const auto filename_utf8{PATH2UTF8(filename)};

	if (avformat_open_input(&_fmt, filename_utf8.c_str(), nullptr, nullptr) < 0)
