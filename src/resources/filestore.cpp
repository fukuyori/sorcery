...
Sorcery::FileStore::FileStore() {
	...
	_add_directory(DATA_DIR, FONT_DIR, true);
	...
	_add_path(DATA_DIR, FONT_DIR, MONOSPACE_1_C64_FILE);
	_add_path(DATA_DIR, FONT_DIR, MONOSPACE_1_DOS_FILE);
	_add_path(DATA_DIR, FONT_DIR, MONOSPACE_1_MSX2_FILE);
	_add_path(DATA_DIR, FONT_DIR, MONOSPACE_5_DOS_FILE);
	_add_path(DATA_DIR, FONT_DIR, MONOSPACE_5_FMTOWNS_FILE);

	_add_path(DATA_DIR, FONT_DIR, PROPORTIONAL_FONT_FILE);
	_add_path(DATA_DIR, FONT_DIR, TEXT_FONT_FILE);
	...
	_add_path(GFX_DIR, CONTROLS_TEXTURE);
...
auto Sorcery::FileStore::get_path(const std::string_view key) const -> std::filesystem::path {
...
auto Sorcery::FileStore::get_directory_path(std::string_view key) const -> std::filesystem::path {
